...
export default function ViewBorrowReports({ borrowId }) {
  ...
  useEffect(() => {
    const fetchReports = async (borrowId) => {
      setLoading(true)
      const response = await getReports(borrowId, pageNo)
      if (response) {
