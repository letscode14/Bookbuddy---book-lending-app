...
import { removeReports } from "../../../../../Service/Apiservice/AdminApi";

export default function ViewReports({ reports }) {
  ...
  useEffect(() => {
    reports.forEach((element) => {
      console.log(element);
      element.reportedOn = new Date(element.reportedOn).toDateString();
    });
    setReports(reports);
  }, []);
            ...
            <div className="flex justify-between items-center">
              <div className="text-sm  font-medium text-gray-500">
                ...
                <div className="flex mt-1">
                  ...
                  <span className="text-black text-[16px]">: {r?.status}</span>
                </div>
                <div className="flex mt-1">
