...
export default function ViewLended({ lend }) {
      ...
      {data ? (
        <div className="h-full">
          ...
          <div className="text-sm mt-2 font-semibold text-gray-400">
            <div>
              ...
              <span className="ms-2 text-[#000000]">
                {new Date(data.lendedOn).toDateString()}
              </span>
            </div>
            <div>
              <span>
            ...
            <div>
              ...
              data.requestDetails.stage == 'times up' ? (
                <div className="text-[#000000] font-medium py-[3px] text-sm inline-block px-3 rounded-lg mt-2  bg-[#ede9f7]">
                  ...
                  />
                  {data.remainingDays} Days left times up ! ask for the book
                </div>
          ...
          <div className=" mt-2  w-full  flex gap-3 justify-center font-medium text-[#000000]">
            {data?.hasMadeRefund ? (
              <div className="text-[#000000] font-medium py-[3px] text-sm inline-block px-3 rounded-lg mt-2  bg-[#ede9f7]">
                <FontAwesomeIcon
                  ...
                  className="me-2 text-red-500"
                />
                Already made refund you cannot repost this transaction anymore
              </div>
            ) : (
              <button
                onClick={() => {
            ...
            data.requestDetails.stage == 'times up' ? (
              <button className="border border-[#512da8] text-[#512da8] text-xs font-semibold   w-28 text-sm py-1 rounded-lg uppercase">
                Ask for book
              </button>
